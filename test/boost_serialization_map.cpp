...
#include <boost/serialization/coruja_map.hpp>
...
int main()
{
    ...
    {
        coruja::map<int, coruja::object<std::string>> obj;
    ...
    
    {
        ...
        boost::archive::text_iarchive ia(in);
        ia >> obj;
        coruja::map<int, coruja::object<std::string>> expected;
